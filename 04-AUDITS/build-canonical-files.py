...
TABLE = [
 ...
 ("CORRECTIONS-PENDING.md", "Page corrections awaiting individual approval", "CANONICAL", "", "constitution step 13", "museum-translator", "NOT-VALIDATED", "", "",
  "Prose. Four page briefs held for the owner to approve one at a time; allocates no identifier of its own."),
 ...
 ("03-REGISTERS/rigveda-pur-passages.csv", "Section 4J passage index", "CANONICAL", "", "constitution section 4J", "corpus-analyst", "GATED", "PUR-P-", "",
  "Issues PUR-P-. The 103 stanza-sized rows the section 4J corpus is keyed on; the passage unit itself is D-044."),
 ("03-REGISTERS/rigveda-pur-fields.csv", "Section 4J semantic fields", "CANONICAL", "", "constitution section 4J", "corpus-analyst", "GATED", "PUR-P-", "",
  "Per-passage attribute table. Its passage_id is rigveda-pur-passages.csv's identifier, not one of its own; declared in FOREIGN_KEY_REGISTERS so the cross-register uniqueness check reads it as a reference."),
 ("03-REGISTERS/rigveda-pur-typology.csv", "Section 4J passage typology", "CANONICAL", "", "constitution section 4J", "corpus-analyst", "GATED", "PUR-P-", "",
  "Per-passage attribute table on the same foreign key as rigveda-pur-fields.csv."),
 ("03-REGISTERS/rigveda-pur-counts.csv", "Section 4J fort counts", "CANONICAL", "", "constitution section 4J", "corpus-analyst", "GATED", "PUR-N-", "", "Data table, one row per numeral adjudicated."),
 ("03-REGISTERS/rigveda-pur-4j-claims.csv", "Section 4J claims", "CANONICAL", "", "constitution section 4J", "corpus-analyst", "GATED", "PUR4J-", "", ""),
 ("03-REGISTERS/rigveda-pur-4j-interpretations.csv", "Section 4J interpretations", "CANONICAL", "", "constitution section 4J", "corpus-analyst", "GATED", "PUR4J-I-", "",
  "Readings, never measurements. Held at PROVISIONAL by their own method note."),
 ("03-REGISTERS/rigveda-varna.csv", "Rigvedic varna- claims", "CANONICAL", "", "PROGRAMME.md step 4", "corpus-analyst", "GATED", "VAR-", "", ""),
 ("03-REGISTERS/rigveda-varna-occurrences.csv", "Rigvedic varna- occurrences", "CANONICAL", "", "PROGRAMME.md step 4", "corpus-analyst", "GATED", "VAR-OCC-", "", "Data table."),
 ("03-REGISTERS/dedr-digitisation-lineage.csv", "DEDR digitisation lineage", "CANONICAL", "", "constitution step 5", "source-genealogist", "GATED", "DEDR-L-", "",
  "Which DEDR digitisations descend from one upstream. Read with 02-SOURCES/dependency.csv DEP-025 and DEP-026."),
 ...
 ("04-AUDITS/INTERNAL-CONTRADICTIONS.csv", "Contradictions in the evidence", "CANONICAL", "", "constitution section 9", "adversarial-reviewer", "GATED", "IC-E-|IC-P-", "",
  "Evidence contradictions only. Control-plane contradictions go to 00-CONTROLLER/CONTRADICTION-REGISTER.csv. IC-P- is the page series added with the MVP-fifteen briefs; both are evidence contradictions and share this register."),
 ...
 ("04-AUDITS/dedr-lineage-check.csv", "Measurement output", "CANONICAL", "", "PROGRAMME.md step 4", "corpus-analyst", "NOT-VALIDATED", "", "",
  "Script output of 04-AUDITS/dedr-lineage-check.py, not a register. Listed by name for the same reason as domain-e-dedr-digitisation-check.csv: no `04-AUDITS/*.csv` catch-all."),
 ("04-AUDITS/domain-e-dedr-digitisation-check.csv", "Measurement output", "CANONICAL", "", "PROGRAMME.md step 4", "corpus-analyst", "NOT-VALIDATED", "", "",
  "Script output, not a register. Listed by name: a `04-AUDITS/*.csv` catch-all used to map any new CSV dropped here to NOT-VALIDATED, which excused a register from validation by filename."),
