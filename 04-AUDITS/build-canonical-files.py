...
TABLE = [
 ...
 ("03-REGISTERS/domain-e-hydronyms.csv", "Rigvedic hydronym occurrences", "CANONICAL", "", "PROGRAMME.md step 4", "corpus-analyst", "GATED", "", "", "Data table. Rows are evidence for claims stated elsewhere, not claims."),
 ("03-REGISTERS/domain-e-retroflex-residue.csv", "Retroflex residue lemmas", "CANONICAL", "", "PROGRAMME.md step 4", "corpus-analyst", "GATED", "", "", "Data table."),
 ("03-REGISTERS/domain-e-cdial-loan-candidates.csv", "CDIAL loan candidates", "CANONICAL", "", "PROGRAMME.md step 4", "corpus-analyst", "GATED", "", "", "Data table."),
 ...
 ("03-REGISTERS/domain-e-geography.csv", "Dravidian geographic measures", "CANONICAL", "", "PROGRAMME.md step 4", "corpus-analyst", "NOT-VALIDATED", "GEO-", "", "Data table with no source column; its sources are recorded in the method note."),
 ("03-REGISTERS/rigveda-pur-family-occurrences.csv", "pur-family occurrences", "CANONICAL", "", "PROGRAMME.md step 4", "corpus-analyst", "GATED", "", "", "Data table."),
 ...
 ("09-DECISIONS/DECISION-ID-MAP.csv", "Decision identifier aliases", "CANONICAL", "", "09-DECISIONS/README.md", "director session", "GATED", "", "", "Rows are never removed."),
