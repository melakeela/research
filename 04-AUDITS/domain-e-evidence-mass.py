...
Sources (02-SOURCES/access-ledger.csv):
  SRC-056  JAMBU data/dedr/dedr_new.csv     DEDR reflexes
  SRC-057  JAMBU data/dedr/pdr.csv          Proto-Dravidian after Krishnamurti
  SRC-058  JAMBU data/munda/forms.csv       attested Munda reflexes
  SRC-059  JAMBU data/munda/rau_2019.csv    Proto-Munda, Rau 2019
  SRC-060  JAMBU data/cdial/params.csv      CDIAL entry texts (Turner)
  SRC-062  lexibank/dravlex cldf/           DravLex cognate coding
  SRC-063  HOLD: the substrate literature is unretrieved
...
rows = [
 ("EM-01", "1", "attested Dravidian languages",
  ...
  len(dedr_langs), "SRC-056", "JAMBU data/dedr/dedr_new.csv, field 1",
 ...
 ("EM-02", "1", "attested Dravidian languages",
  "reflex rows in the retrieved DEDR table", dedr_rows, "SRC-056",
 ...
 ("EM-03", "1", "attested Dravidian languages",
  "distinct DEDR entry numbers in the retrieved table", len(dedr_entries), "SRC-056",
  "JAMBU data/dedr/dedr_new.csv, field 2",
  "Cannot be checked against the printed 1984 edition: dsal.uchicago.edu is EGRESS_BLOCKED (SRC-051)."),
 ("EM-04", "1", "attested Dravidian languages",
  "varieties in DravLex, a second and differently built sample", dl_langs, "SRC-062",
 ...
 ("EM-05", "1", "attested Dravidian languages",
  "cognate sets coded in DravLex", dl_cogsets, "SRC-062",
 ...
 ("EM-06", "2", "reconstructed Proto-Dravidian",
  ...
  len(pdr_forms), "SRC-057", "JAMBU data/dedr/pdr.csv, field 3",
 ...
 ("EM-07", "2", "reconstructed Proto-Dravidian",
  "DEDR entries for which a Proto-Dravidian form is offered", len(pdr_entries), "SRC-057",
 ...
 ("EM-08", "2", "reconstructed Proto-Dravidian",
  ...
  round(100.0 * len(pdr_entries) / len(dedr_entries), 1), "SRC-056; SRC-057",
 ...
 ("EM-09", "3", "accepted Old Indo-Aryan Dravidian loans",
  ...
  "SRC-060", "JAMBU data/cdial/params.csv, entry text, regex '←...Drav.'",
 ...
 ("EM-10", "3", "accepted Old Indo-Aryan Dravidian loans",
  ...
  len(c_drav), "SRC-060", "JAMBU data/cdial/params.csv, entry text, regex 'Drav.'",
 ...
 ("EM-11", "5", "attested Munda languages",
  ...
  len(mu_langs), "SRC-058", "JAMBU data/munda/forms.csv, field 1 excluding PMu",
 ...
 ("EM-12", "5", "attested Munda languages",
  "attested Munda reflex rows in that table", mu_rows - len(pmu_forms), "SRC-058",
 ...
 ("EM-13", "6", "reconstructed Proto-Munda",
  ...
  "SRC-059", "JAMBU data/munda/rau_2019.csv, one row per etymon",
 ...
 ("EM-14", "7", "pre-Proto-Munda / deeper Austroasiatic",
  ...
  rau_with_mkcd, "SRC-059", "JAMBU data/munda/rau_2019.csv, field mkcd_no",
 ...
 ("EM-15", "7", "pre-Proto-Munda / deeper Austroasiatic",
  "of those etyma, the number carrying a Pinnow number", rau_with_pinnow, "SRC-059",
 ...
 ("EM-16", "5,6,7", "Munda, all three layers together",
  ...
  "SRC-060", "JAMBU data/cdial/params.csv, entry text, regex '←...Muṇḍ'",
  "Turner's attribution, and several of his Munda attributions are themselves credited to Kuiper, who is not retrieved (HOLD-004)."),
 ("EM-17", "5,6,7", "Munda, all three layers together",
  "CDIAL entries mentioning Munda at all", len(c_mund), "SRC-060",
 ...
 ("EM-19", "4", "proposed Dravidian substrate forms",
  "items measurable from sources retrieved in this session", 0, "SRC-063",
  "05-HOLDS/HOLD-004-substrate-literature.md",
