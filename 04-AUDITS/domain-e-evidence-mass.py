...
Sources (02-SOURCES/access-ledger.csv):
  SRC-061  JAMBU data/dedr/dedr_new.csv     DEDR reflexes
  SRC-062  JAMBU data/dedr/pdr.csv          Proto-Dravidian after Krishnamurti
  SRC-063  JAMBU data/munda/forms.csv       attested Munda reflexes
  SRC-064  JAMBU data/munda/rau_2019.csv    Proto-Munda, Rau 2019
  SRC-065  JAMBU data/cdial/params.csv      CDIAL entry texts (Turner)
  SRC-067  lexibank/dravlex cldf/           DravLex cognate coding
  SRC-068  HOLD: the substrate literature is unretrieved
...
rows = [
 ("EM-01", "1", "attested Dravidian languages",
  ...
  len(dedr_langs), "SRC-061", "JAMBU data/dedr/dedr_new.csv, field 1",
 ...
 ("EM-02", "1", "attested Dravidian languages",
  "reflex rows in the retrieved DEDR table", dedr_rows, "SRC-061",
 ...
 ("EM-03", "1", "attested Dravidian languages",
  "distinct DEDR entry numbers in the retrieved table", len(dedr_entries), "SRC-061",
  "JAMBU data/dedr/dedr_new.csv, field 2",
  "Cannot be checked against the printed 1984 edition: dsal.uchicago.edu is EGRESS_BLOCKED (SRC-056)."),
 ("EM-04", "1", "attested Dravidian languages",
  "varieties in DravLex, a second and differently built sample", dl_langs, "SRC-067",
 ...
 ("EM-05", "1", "attested Dravidian languages",
  "cognate sets coded in DravLex", dl_cogsets, "SRC-067",
 ...
 ("EM-06", "2", "reconstructed Proto-Dravidian",
  ...
  len(pdr_forms), "SRC-062", "JAMBU data/dedr/pdr.csv, field 3",
 ...
 ("EM-07", "2", "reconstructed Proto-Dravidian",
  "DEDR entries for which a Proto-Dravidian form is offered", len(pdr_entries), "SRC-062",
 ...
 ("EM-08", "2", "reconstructed Proto-Dravidian",
  ...
  round(100.0 * len(pdr_entries) / len(dedr_entries), 1), "SRC-061; SRC-062",
 ...
 ("EM-09", "3", "accepted Old Indo-Aryan Dravidian loans",
  ...
  "SRC-065", "JAMBU data/cdial/params.csv, entry text, regex '←...Drav.'",
 ...
 ("EM-10", "3", "accepted Old Indo-Aryan Dravidian loans",
  ...
  len(c_drav), "SRC-065", "JAMBU data/cdial/params.csv, entry text, regex 'Drav.'",
 ...
 ("EM-11", "5", "attested Munda languages",
  ...
  len(mu_langs), "SRC-063", "JAMBU data/munda/forms.csv, field 1 excluding PMu",
 ...
 ("EM-12", "5", "attested Munda languages",
  "attested Munda reflex rows in that table", mu_rows - len(pmu_forms), "SRC-063",
 ...
 ("EM-13", "6", "reconstructed Proto-Munda",
  ...
  "SRC-064", "JAMBU data/munda/rau_2019.csv, one row per etymon",
 ...
 ("EM-14", "7", "pre-Proto-Munda / deeper Austroasiatic",
  ...
  rau_with_mkcd, "SRC-064", "JAMBU data/munda/rau_2019.csv, field mkcd_no",
 ...
 ("EM-15", "7", "pre-Proto-Munda / deeper Austroasiatic",
  "of those etyma, the number carrying a Pinnow number", rau_with_pinnow, "SRC-064",
 ...
 ("EM-16", "5,6,7", "Munda, all three layers together",
  ...
  "SRC-065", "JAMBU data/cdial/params.csv, entry text, regex '←...Muṇḍ'",
  "Turner's attribution, and several of his Munda attributions are themselves credited to Kuiper, who is not retrieved (HOLD-005)."),
 ("EM-17", "5,6,7", "Munda, all three layers together",
  "CDIAL entries mentioning Munda at all", len(c_mund), "SRC-065",
 ...
 ("EM-19", "4", "proposed Dravidian substrate forms",
  "items measurable from sources retrieved in this session", 0, "SRC-068",
  "05-HOLDS/HOLD-005-substrate-literature.md",
