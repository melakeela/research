# `the-languages-we-lost` — page brief

**Page:** *Language Isolates of South Asia: Burushaski, Kusunda, Nihali* · MVP rank **12** of 15 · `Nocturnal Veḷi` · Decision `Keep` · Risk `Low`
...
6. The distinction between *isolate* (no demonstrated relatives) and *unrelated* (relatives shown not to exist) is explicit. They are not the same claim and the second is almost never demonstrable.
